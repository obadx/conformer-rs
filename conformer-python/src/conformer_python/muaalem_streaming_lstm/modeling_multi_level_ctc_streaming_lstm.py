...
from .configuration_multi_level_ctc_streaming_lstm import (
    Wav2Vec2BertForMultilevelCTCStreamingLSTMConfig,
)
...
class Wav2Vec2BertModel(Wav2Vec2BertPreTrainedModel):
    def __init__(self, config: Wav2Vec2BertForMultilevelCTCConfig):
...
class Wav2Vec2BertForMultilevelCTCStreamingLSTM(Wav2Vec2BertPreTrainedModel):
    config_class = Wav2Vec2BertForMultilevelCTCStreamingLSTMConfig
